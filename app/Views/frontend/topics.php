...
<section class="contact py-5" id="contact">
    <div class="container pt-md-5 pt-4">
        <div class="main-grid-contact">
            ...
            <div class="row">
                <div class="col-lg-5 col-md-12  col-sm-12 order-first" id="hide_mobile">
                    <div class="col">
                        <table class="table table-striped table-advance table-hover " style=" border-collapse:separate;border-spacing: 0 0em;">
                            <thead>
                                <tr style="text-align: center;">
                ...
                <!-- contact form -->
                <div class="col-lg-7 col-md-12  col-sm-12 content-form-right p-0 order-lg-last" id="hide_mobile">
